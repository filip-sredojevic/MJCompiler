...
public class CondFactListExpand extends CondFactList {

    private CondFactList CondFactList;
    private CondFact CondFact;

    public CondFactListExpand (CondFactList CondFactList, CondFact CondFact) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("CondFactListExpand(\n");
