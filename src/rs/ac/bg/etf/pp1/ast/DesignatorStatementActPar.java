...
public class DesignatorStatementActPar extends DesignatorStatement {

    private Designator Designator;
    private ActParsList ActParsList;

    public DesignatorStatementActPar (Designator Designator, ActParsList ActParsList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorStatementActPar(\n");
