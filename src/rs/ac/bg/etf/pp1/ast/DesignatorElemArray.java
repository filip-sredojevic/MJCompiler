...
public class DesignatorElemArray extends Designator {

    private DesignatorArrayName DesignatorArrayName;
    private Expr Expr;

    public DesignatorElemArray (DesignatorArrayName DesignatorArrayName, Expr Expr) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorElemArray(\n");
