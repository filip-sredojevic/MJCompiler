...
public class FactorValueMethod extends FactorValue {

    private Designator Designator;
    private ActParsList ActParsList;

    public FactorValueMethod (Designator Designator, ActParsList ActParsList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("FactorValueMethod(\n");
