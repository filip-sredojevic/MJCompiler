...
public class CondTermListExpand extends CondTermList {

    private CondTermList CondTermList;
    private CondTerm CondTerm;

    public CondTermListExpand (CondTermList CondTermList, CondTerm CondTerm) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("CondTermListExpand(\n");
